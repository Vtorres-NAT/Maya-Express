      ...
      <div className="grid grid-cols-12 gap-10">
        ...
        <div className="col-span-12 xl:col-span-4 space-y-4">
          ...
          {[
            ...
            <div key={i} className={`p-5 rounded-2xl shadow-sm transition-all cursor-pointer ${
              item.active ? 'bg-primary text-white shadow-xl shadow-primary/20 scale-105' : 'bg-white border border-slate-200 hover:border-primary'
            }`}>
              <div className="flex justify-between items-start mb-3">
                ...
                <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${
                  item.active ? 'bg-white/20' : 'bg-emerald-50 text-emerald-600'
                }`}>{item.status}</span>
              </div>
